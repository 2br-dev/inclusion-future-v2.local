...
$dbase = 'inclusion';
$table_prefix = 'modx_';
$database_dsn = 'mysql:host=localhost;dbname=inclusion;charset=utf8';
...
if (!defined('MODX_HTTP_HOST')) {
    if(defined('PHP_SAPI') && (PHP_SAPI == "cli" || PHP_SAPI == "embed")) {
        $http_host='inclusion.local';
        define('MODX_HTTP_HOST', $http_host);
    } else {
        $http_host = array_key_exists('HTTP_HOST', $_SERVER) ? parse_url($url_scheme . $_SERVER['HTTP_HOST'], PHP_URL_HOST) : 'inclusion.local';
